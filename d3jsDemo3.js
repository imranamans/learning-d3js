...
function makeDemo() {
    ...
    const minValue = Math.min(...yDomainValues);
    const minDomain = minValue < thresholdLow ? minValue : thresholdLow;

    const maxValue = Math.max(...yDomainValues);
    const maxDomain = maxValue > thresholdHigh ? maxValue : thresholdHigh;
